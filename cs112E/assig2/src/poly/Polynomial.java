...
public class Polynomial {
	...
	public Polynomial add(Polynomial p) {
		...
		while(this.poly != null && p.poly != null)
		{
			...
			{
				returnFront.poly = new Node(this.poly.term.coeff + p.poly.term.coeff, this.poly.term.degree, returnFront.poly);
				this.poly = this.poly.next;
				p.poly = p.poly.next;
			}
			else if(this.poly.term.degree > p.poly.term.degree)
			{
				returnFront.poly = new Node(p.poly.term.coeff, p.poly.term.degree, returnFront.poly);
				p.poly = p.poly.next;
			}
			else
			{
				returnFront.poly = new Node(this.poly.term.coeff, this.poly.term.degree, returnFront.poly);
				this.poly = this.poly.next;
			}
		}
